...
#endif
#define DISABLE_C2IND_ANALOG()   CONFIG_AN4_AS_DIGITAL() 
#define DISABLE_U2CTS_ANALOG()   
#define DISABLE_CTPLS_ANALOG()   CONFIG_AN11_AS_DIGITAL() 
#define DISABLE_U4TX_ANALOG()   
#define DISABLE_SS2_ANALOG()   
#define DISABLE_U3TX_ANALOG()   
#define DISABLE_C1OUT_ANALOG()   
#define DISABLE_INT1_ANALOG()   CONFIG_AN10_AS_DIGITAL() 
#define DISABLE_U1RTS_ANALOG()   
#define DISABLE_T5CK_ANALOG()   
#define DISABLE_C1IND_ANALOG()   CONFIG_AN2_AS_DIGITAL() 
#define DISABLE_U3CTS_ANALOG()   
#define DISABLE_OC5_ANALOG()   
#define DISABLE_U2TX_ANALOG()   CONFIG_AN2_AS_DIGITAL() 
#define DISABLE_C2INA_ANALOG()   CONFIG_AN3_AS_DIGITAL() 
#define DISABLE_INT0_ANALOG()   
#define DISABLE_U1BCLK_ANALOG()   CONFIG_AN4_AS_DIGITAL() 
#define DISABLE_SS1_ANALOG()   
#define DISABLE_IC4_ANALOG()   
#define DISABLE_OCFB_ANALOG()   
#define DISABLE_C1TX_ANALOG()   
#define DISABLE_RTCC_ANALOG()   CONFIG_AN10_AS_DIGITAL() 
#define DISABLE_IC3_ANALOG()   
#define DISABLE_T3CK_ANALOG()   
#define DISABLE_C2OUT_ANALOG()   
#define DISABLE_INT2_ANALOG()   
#define DISABLE_OCFA_ANALOG()   CONFIG_AN10_AS_DIGITAL() 
#define DISABLE_OC4_ANALOG()   
#define DISABLE_U1RX_ANALOG()   CONFIG_AN4_AS_DIGITAL() 
#define DISABLE_IC8_ANALOG()   
#define DISABLE_U3RX_ANALOG()   
#define DISABLE_CTED2_ANALOG()   CONFIG_AN12_AS_DIGITAL() 
#define DISABLE_IC1_ANALOG()   
#define DISABLE_U2BCLK_ANALOG()   CONFIG_AN3_AS_DIGITAL() 
#define DISABLE_C1INA_ANALOG()   CONFIG_AN5_AS_DIGITAL() 
#define DISABLE_T4CK_ANALOG()   
#define DISABLE_C2INC_ANALOG()   CONFIG_AN5_AS_DIGITAL() 
