...
#define ENABLE_RF7_PULLUP() _CN73PUE = 1
#define DISABLE_RF7_PULLUP() _CN73PUE = 0
...
#define ENABLE_RF7_CN_INTERRUPT() _CN73IE = 1
#define DISABLE_RF7_CN_INTERRUPT() _CN73IE = 0
