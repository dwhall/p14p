...
#define DISABLE_RB12_ANALOG() _PCFG9 = 1
#define ENABLE_RB12_ANALOG() _PCFG9 = 0
#define DISABLE_RB13_ANALOG() _PCFG8 = 1
#define ENABLE_RB13_ANALOG() _PCFG8 = 0
...
#define CONFIG_RP12_AS_DIG_PIN()  _PCFG9 = 1
#define CONFIG_RP13_AS_DIG_PIN()  _PCFG8 = 1
